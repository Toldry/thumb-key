...
![](./user_guide_images/modify_keys_example_1.png)
This JSON string modifies the key in the second row, first column, center letter from 'n' to 'ñ'.
- `ENThumbKey` specifies which keyboard to change. In this case, it's the (default) 'english thumbkey' layout.
    - Look [here](./app/src/main/java/com/dessalines/thumbkey/utils/KeyboardLayout.kt) for all keyboard layouts.
...
```
![](./user_guide_images/modify_keys_example_2.png)
